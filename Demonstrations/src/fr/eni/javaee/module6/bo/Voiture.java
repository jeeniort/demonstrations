...
public class Voiture implements Serializable {
	...
	public String toHTML() {
		return "<h1>" + marque + "</h1>" + "<p>" + this.toString() + "</p>";
	}
	...
	public Voiture getPetitFrere() {
		return petitFrere;
	}
	public void setPetitFrere(Voiture petitFrere) {
		this.petitFrere = petitFrere;
	}
