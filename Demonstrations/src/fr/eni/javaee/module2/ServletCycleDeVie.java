...
public class ServletCycleDeVie extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.getWriter().append("nombreAppelServlet : ")
			.append(String.valueOf(this.nombreAppelServlet));
		response.getWriter().append(System.lineSeparator());
		response.getWriter().append("nombrePassageInit : ")
			.append(String.valueOf(this.nombrePassageInit));
		response.getWriter().append(System.lineSeparator());
		response.getWriter().append("nombreDestruction : ")
			.append(String.valueOf(this.nombreDestruction));
	}
	/**
